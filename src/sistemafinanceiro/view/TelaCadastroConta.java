...
//        if (nc.getQtdParcela() >= 2) {
//            Calendar calendar = Calendar.getInstance();
//            Date agora = dcData.getDate();
//            calendar.setTime(agora);
//            System.out.println("Nome: " + nc.getNome() + "\nValor: " + nc.getValor() + "\nQuantidade de parcelas: " + jlQtdParcela.getText() + "\nData: " + formatarData(dcData.getDate()));
//            for (int i = 0; i < nc.getQtdParcela(); i++) {
//                calendar.add(Calendar.MONTH, 1);
//                System.out.println("\nParcela " + (i + 1) + " :" + formatarData(calendar.getTime()));
//            }
//        } else {
//            System.out.println("Nome: " + nc.getNome() + "\nValor: " + nc.getValor() + "\nQuantidade de parcelas: " + nc.getQtdParcela() + "\nVencimento: " + formatarData(dcData.getDate()));
//        }
